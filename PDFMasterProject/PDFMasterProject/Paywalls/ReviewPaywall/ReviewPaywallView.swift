//
//  ReviewPaywallView.swift
//  PDFMaster
//
//  Created by George Popkich on 3.02.25.
//

import SwiftUI
import SUINavigation

struct ReviewPaywallView: View {
    ...
    @StateObject var viewModel: ReviewPaywallViewModel
        ...
        ZStack {
            ...
            VStack {
                ...
                VStack {
                    ...
                    Text(Constants.subTitleText(price: viewModel.trialDidSelect ? viewModel.trialPrice : viewModel.weeklyPrice))
                    ...
                    TrialToggleView() { toggleState in
                        viewModel.switchToggle(toggleState)
                    }
                    .padding(.bottom, 24)
                    .padding(.horizontal, 36)

                    BouncingButton(title: Constants.subButtonTitle(price: viewModel.trialDidSelect ? viewModel.trialPrice : viewModel.weeklyPrice)) {
                        Task {
